...
- `validate-compass-follow.js` — 初期OFF・ファイル読込時の許可要求なし、iPhone相当で方位ボタン押下時だけ許可要求、直接ON/OFF、Android/WebViewの非absolute方位、45ms応答の滑らかな補間、ホーム停止と初期角度復帰を確認。3回連続成功。
