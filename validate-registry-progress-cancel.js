...
(async()=>{
  ...
  if(!desktopResult.panelCancel.aborted||desktopResult.panelCancel.busy||desktopResult.panelCancel.text!=="境界")throw new Error(`境界ボタンでキャンセルできません: ${JSON.stringify(desktopResult.panelCancel)}`);
