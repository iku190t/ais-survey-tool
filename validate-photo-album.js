...
const checks = [
  ...
  ["全枚数共通の見開き選択", /id="photoAlbumSpread"[^>]*type="checkbox"[^>]*>見開きにする/],
  ["旧見開き3枚設定の移行", /const legacySpread=String\(saved\.layout\)==="spread";[\s\S]*layout:legacySpread\?"3"[\s\S]*spread:legacySpread\|\|saved\.spread===true/],
  ...
  ["見開きは選択枚数を維持", /const isSpread=!!settings\.spread,photosPerPage=Number\(settings\.layout\)\|\|3;[\s\S]*rowsPerPage=isSpread\?photosPerPage/],
