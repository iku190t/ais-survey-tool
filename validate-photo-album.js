...
const checks = [
  ...
  ["3枚は以前の写真・コメント幅", /const photoColumnPx=widePhotoLayout\?72:60,commentColumnPx=\(widePhotoLayout\|\|fourPhotoLayout\)\?48:60/],
  ...
  ["6枚は写真と狭い右コメント欄へ分割", /const sixPhotoColumnWidthsPx=\[70,70,70,13,65,65,13,70,70,70,13,65,65\]/],
  ["6枚は右欄へコメント3行と豆図", /if\(sixPhotoLayout\)[\s\S]*fields\.forEach\(\(field,line\)=>mergeComment\(slotTop\+1\+line\*2[\s\S]*makePhotoMiniMapImage\(item,miniGeometry/],
