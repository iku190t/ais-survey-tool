...
const required=[
  ...
  'drawingReferenceBounds:hasLoadedDrawing()?getGpsDrawingReferenceBoundsWorld():getSimaBoundsWorld()',
  ...
  'const distanceUnavailable=!!(state&&(state.hadDrawing||state.hadSima)&&distance==null);',
  ...
  'return hasLoadedDrawing()||hasLoadedSimaWorkspace()||gpsOnlyBlankMode;',
